...
#define LAN8720_PHY_ADDRESS  	0x00				//LAN8720 PHY芯片地址.  高电平 1 无数据  dhcp失败       0 有数据 dhcp失败
																		 //低电平  1 无数据 dhcp成功      0 有数据 dhcp失败
																		 //浮空    1 无数据 dhcp成功     0 有数据 dhcp失败
																		 
																		 //原子 浮空 1无数据 无dhcp 0 能读 能dhcp
